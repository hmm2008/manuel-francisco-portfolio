    ...
    <div id="gallery-grid-wrapper" className="flex-1 w-full min-h-0 flex flex-col justify-between overflow-hidden relative">
      ...
      >
        {processedImages.length === 0 ? (
          ...
          <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-4 gap-3 xs:gap-4 w-full overflow-y-auto max-h-full pb-4">
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 transition-transform duration-300 group-hover:scale-105 flex items-center justify-center p-1.5">
                    ...
                    {/* Watermark Overlay */}
                    {enableWatermark && (
                      <div className="absolute bottom-2 left-2 pointer-events-none select-none text-[8px] font-sans tracking-widest text-white/70 bg-black/40 px-1.5 py-0.5 rounded backdrop-blur-[1px]">
                        {watermarkText}
                      </div>
                    )}
                  </div>
                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 transition-transform duration-500 ease-out group-hover:scale-105 flex items-center justify-center p-2">
                      ...
                      {/* Watermark Overlay */}
                      {enableWatermark && (
                        <div className="absolute bottom-2.5 left-2.5 pointer-events-none select-none text-[9px] font-sans tracking-widest text-white/80 bg-black/50 px-2 py-0.5 rounded backdrop-blur-[2px] shadow-sm">
                          {watermarkText}
                        </div>
                      )}
                    </div>
