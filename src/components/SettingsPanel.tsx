...
export default function SettingsPanel({ onBackToGallery }: { onBackToGallery?: () => void }) {
  ...
  const INITIAL_SETTINGS: SiteSettings = {
    ...
    biographySectionTitle: 'Biografia',
    biographySectionSubtitle: 'Sobre o Fotógrafo',
    biographyTitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    biographyTitleFontSize: '24px',
    biographyTitleColor: '#4a4a4a',
    biographyTitleStyle: '',
    biographyTitleLetterSpacing: '1px',
    biographySubtitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    biographySubtitleFontSize: '12px',
    biographySubtitleColor: '#7a7a7a',
    biographySubtitleStyle: '',
    biographySubtitleLetterSpacing: '2px',
    ...
    biographyFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    biographyFontSize: '15px',
    biographyColor: '#4a4a4a',
    biographyStyle: '',
    biographyLetterSpacing: '0px',
    
    publishedWorksSectionTitle: 'Trabalhos Publicados',
    publishedWorks: '1985 — Revista "Mais" no espaço as suas fotos\n1988 — Anuário Português de Fotografia\n2006 — Foto Plus\n2006 — Participação numa brochura para uma agência de turismo.',
    publishedWorksFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    publishedWorksFontSize: '13px',
    publishedWorksColor: '#4a4a4a',
    publishedWorksStyle: '',
    publishedWorksLetterSpacing: '0px',

    exhibitionsSectionTitle: 'Exposições',
    exhibitions: 'Março 2005 — "Encontro de olhares" - Fórum Cultural de Ermesinde\nJaneiro 2006 — "Encontro de olhares" - Paços do concelho - Pinheiro da Bemposta\nFevereiro 2006 — "Encontro de Olhares" - Biblioteca Municipal da Covilhã\nFevereiro 2006 — "Sensibilidades" - Integrada no projecto Photographyaproject2006\nMarço 2006 — "Encontro de Olhares" - Cine-Teatro Caracas - Oliveira de Azeméis\nMaio 2006 — "Rostos da Raia" - integrada num trabalho realizado para a Adraces - Casa de Artes e Cultura do Tejo - Vila Velha de Rodão',
    exhibitionsFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    exhibitionsFontSize: '13px',
    exhibitionsColor: '#4a4a4a',
    exhibitionsStyle: '',
    exhibitionsLetterSpacing: '0px',

    // Contact Page Defaults
    contactSectionTitle: 'Contacto',
    contactSectionSubtitle: 'ENTRE EM CONTACTO',
    contactTitleFont: 'Cormorant Garamond — serif clássico e elegante',
    contactTitleFontSize: '36px',
    contactTitleColor: '#4a4a4a',
    contactTitleStyle: '',
    contactTitleLetterSpacing: '0px',
    contactSubtitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    contactSubtitleFontSize: '10px',
    contactSubtitleColor: '#7a7a7a',
    contactSubtitleStyle: '',
    contactSubtitleLetterSpacing: '2px',
    contactFormLabelFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    contactFormLabelSize: '10px',
    contactFormLabelColor: '#4a4a4a',
    contactFormLabelLetterSpacing: '2px',

    // Guestbook Page Defaults
    guestbookSectionTitle: 'Livro de Visitas',
    guestbookSectionSubtitle: 'LIVRO DE VISITANTES',
    guestbookTitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    guestbookTitleFontSize: '24px',
    guestbookTitleColor: '#4a4a4a',
    guestbookTitleStyle: '',
    guestbookTitleLetterSpacing: '1px',
    guestbookSubtitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    guestbookSubtitleFontSize: '10px',
    guestbookSubtitleColor: '#7a7a7a',
    guestbookSubtitleStyle: '',
    guestbookSubtitleLetterSpacing: '2px',

    // Links Page Defaults
    linksSectionTitle: 'Links',
    linksSectionSubtitle: 'RECURSOS',
    linksTitleFont: 'Cormorant Garamond — serif clássico e elegante',
    linksTitleFontSize: '36px',
    linksTitleColor: '#4a4a4a',
    linksTitleStyle: '',
    linksTitleLetterSpacing: '0px',
    linksSubtitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    linksSubtitleFontSize: '10px',
    linksSubtitleColor: '#7a7a7a',
    linksSubtitleStyle: '',
    linksSubtitleLetterSpacing: '2px',
    ...
    // Tipografia & Estilos
    globalLetterSpacing: '0px',
    siteNameLetterSpacing: '0px',
    messageLetterSpacing: '0px',
    menuLetterSpacing: '0px',
    ...
    slideshowControlsLetterSpacing: '1px',
    ...
    showLightboxCategory: true,
    lightboxCategoryPosition: 'canto inferior esq',
    lightboxCategoryPlacement: 'inside',
    lightboxCategoryPadding: 16,
    lightboxCategoryFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    lightboxCategorySize: '11 px',
    lightboxCategoryStyle: '',
    lightboxCategoryColor: '#ffffff',
    lightboxCategoryLetterSpacing: '1px',
    enableLightboxCategoryBg: false,
    lightboxCategoryBgColor: '#000000',
    lightboxTitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    lightboxTitleSize: '18 px',
    lightboxTitleLetterSpacing: '1px',
    lightboxSubtitleFont: 'Plus Jakarta Sans — sans-serif limpo moderno',
    lightboxSubtitleSize: '12 px',
    lightboxSubtitleLetterSpacing: '1px',
    slideshowTitleLetterSpacing: '1px',
    slideshowSubtitleLetterSpacing: '1px',
    lightboxTextPosition: 'canto inferior dir',
    ...
    rightClickTitleLetterSpacing: '1px',
    rightClickSubtitleLetterSpacing: '0px',
    rightClickSize: '14px',
