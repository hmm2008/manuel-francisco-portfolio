...
import { getSlideshowVariants } from '../utils/transitionUtils';
...
interface SlideshowViewProps {
  ...
  slideshowAspects: Record<string, number>;
  setSlideshowAspects: React.Dispatch<React.SetStateAction<Record<string, number>>>;
  slideshowContainerSize: { width: number, height: number } | null;
  slideshowContainerRef: React.RefObject<HTMLDivElement | null>;
